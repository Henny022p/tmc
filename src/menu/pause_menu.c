...
const ItemMenuTableEntry gItemMenuTable[] = {
    [MENU_SLOT_SWORD] = { MENU_SLOT_BOTTLE0, MENU_SLOT_SHIELD, MENU_SLOT_FIREROD, MENU_SLOT_GUST_JAR, 0x01, 0x0c,
                          0x42, 0x33 },
    ...
    [MENU_SLOT_CANE] = { MENU_SLOT_BOTTLE3, MENU_SLOT_LANTERN, MENU_SLOT_GUST_JAR, MENU_SLOT_BOOMERANG, 0x01, 0x14,
                         0x8a, 0x33 },
    [MENU_SLOT_BOOMERANG] = { MENU_SLOT_SAVE_BUTTON, MENU_SLOT_BOMBS, MENU_SLOT_CANE, MENU_SLOT_FIREROD, 0x01, 0x15, 0xae,
                              0x33 },
    ...
    [MENU_SLOT_BOTTLE3] = { MENU_SLOT_OCARINA, MENU_SLOT_CANE, MENU_SLOT_BOTTLE2, MENU_SLOT_SAVE_BUTTON, 0x01, 0x00,
                            0x8a, 0x7b },
    [MENU_SLOT_FIREROD] = { MENU_SLOT_BOTTLE0, MENU_SLOT_SHIELD, MENU_SLOT_BOOMERANG, MENU_SLOT_SWORD, 1, 0, 0x24,
                            0x33 },
